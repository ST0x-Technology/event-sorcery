...
//! `Cons<A, Cons<B, Nil>>`. The [`deps!`](crate::deps) macro provides sugar:
//! `deps![A, B]`.
//!
...
/// by [`register_entities!`](crate::register_entities) (called automatically by
/// [`deps!`](crate::deps)).
...
/// [`register_entities!`](crate::register_entities). Multi-element lists get their impls
...
/// statement-position form of [`deps!`](crate::deps). Prefer using `deps!`
